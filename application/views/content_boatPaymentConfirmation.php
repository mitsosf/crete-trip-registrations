<div id="content">
    <?php if ($this->session->is_logged_in == TRUE) { //if user is logged in
        ...
        if ($participantRealSection != $lcsection) {    //if someone was being naughty
            ...
            echo "<h1> Boat payment Confirmation</h1>";
            echo "<p>Are you sure <b>" . $model_participant->get_participant_Name($participant) . "</b> has payed the boat fee?</p>"; ?>
            <br>
            <?php echo "<p>Participant previous preference <b style='color: red'>" .
                $model_participant->getParticipantBoatPreference
                ($participant) . "</b></p>"; ?>
            <?php
                echo form_open("manage/insertBoatPaymentToDB");
            ?>
            ...
            $data = array(
                "name" => "boatfee",
                "id" => "boatfee",
                "placeholder" => "Boat Fee",
                "class" => "form-control",
                "value" => set_value("gender"),
            );

            $options = array(
                "40" => "BOTH Ways - 40",//change this according to each year's different fees for UOC
                "20" => "TO Crete - 20",
                "21" => "FROM Crete - 20",
            );
