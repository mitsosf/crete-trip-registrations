<div class="content">
    ...
    <div class="row" style="margin-bottom: 50px">
        ...
        <div class="col-sm-6">
            ...
            <p><b style="color: red">You are reminded that your room will only be final when it is full of occupants. If by the end of the rooming process the room is not full, you will be randomly
            ...
            <div class="container-fluid">
                <div class="col-sm-2 ">
                    ...
                    <div class="form-group">
                        ...
                        echo "<h6>Any additional comments for the Organising Committee</h6>";
